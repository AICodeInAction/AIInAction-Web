...
export const learningPaths: PathData[] = [
  ...
  },
  {
    ...
    description:
      "Master AI-powered text generation and NLP. Build content generators, writing assistants, translation tools, and publishing platforms using large language models.",
    icon: "Pen",
    color: "#EC4899",
    order: 5,
  },
  {
    ...
    description:
      "Create AI-powered visual tools from avatar generators to full creative studios. Master image generation APIs, computer vision, style transfer, and visual AI pipelines.",
    icon: "Image",
    color: "#F43F5E",
    order: 6,
  },
  {
    ...
    description:
      "Build AI-powered video tools from auto-captioning to full production suites. Master video generation, editing automation, real-time effects, and streaming pipelines.",
    icon: "Video",
    color: "#EF4444",
    order: 7,
  },
...
export const challenges: ChallengeData[] = [
  ...
  // ===== AI WRITING & CONTENT (101-125) =====
  {
    slug: "ai-blog-post-generator",
    title: "AI Blog Post Generator",
    description:
      "Build a blog post generator that takes a topic and key points, then uses an LLM to produce a well-structured article with headings, paragraphs, and a conclusion. Users can choose tone and length.",
    difficulty: "BEGINNER",
    categorySlug: "ai-writing",
    tags: ["gpt", "content", "blog", "text-generation"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build an email composition assistant that helps users draft professional emails from brief bullet points. Support reply suggestions, tone adjustment, and common email templates for business scenarios.",
    difficulty: "BEGINNER",
    categorySlug: "ai-writing",
    tags: ["email", "gpt", "templates", "productivity"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a summarization tool that condenses long articles, documents, or web pages into concise summaries. Support multiple summary styles including bullet points, executive briefs, and one-line TLDRs.",
    difficulty: "BEGINNER",
    categorySlug: "ai-writing",
    tags: ["summarization", "nlp", "gpt", "content"],
    objectives: [
    ...
    resources: [
      "https://platform.openai.com/docs/guides/text-generation",
      "https://docs.anthropic.com/en/docs/build-with-claude/summarization",
    ],
    estimatedTime: "3-5 hours",
    order: 3,
    pathSlug: "ai-writing",
  },
  {
    ...
    description:
      "Build a grammar and style checking tool that analyzes text for grammatical errors, awkward phrasing, passive voice, and readability issues. Display inline suggestions with explanations for each correction.",
    difficulty: "BEGINNER",
    categorySlug: "ai-writing",
    tags: ["grammar", "nlp", "writing", "editing"],
    objectives: [
  ...
  {
    slug: "ai-social-media-writer",
    title: "AI Social Media Content Writer",
    description:
      "Build a social media content generator that creates platform-specific posts for Twitter/X, LinkedIn, Instagram, and Facebook from a single topic or article. Include hashtag suggestions and character count validation.",
    difficulty: "BEGINNER",
    categorySlug: "ai-writing",
    tags: ["social-media", "content", "gpt", "marketing"],
    objectives: [
  ...
  {
    slug: "ai-story-starter",
    title: "AI Story Starter",
    description:
      "Build a creative story starter tool that generates engaging story openings from a genre, setting, and character description. Users can continue the story interactively with AI assistance for each new paragraph.",
    difficulty: "BEGINNER",
    categorySlug: "ai-writing",
    tags: ["creative-writing", "storytelling", "gpt", "fiction"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a tool that generates compelling product descriptions for e-commerce from product specs, features, and target audience. Support multiple description styles including technical specs, marketing copy, and comparison blurbs.",
    difficulty: "BEGINNER",
    categorySlug: "ai-writing",
    tags: ["copywriting", "ecommerce", "gpt", "marketing"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a translation tool powered by LLMs that goes beyond literal translation to capture context, idioms, and cultural nuances. Support multiple language pairs with side-by-side display and alternative translation suggestions.",
    difficulty: "BEGINNER",
    categorySlug: "ai-writing",
    tags: ["translation", "nlp", "multilingual", "gpt"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a headline generator that creates attention-grabbing titles for articles, videos, and ads. Analyze existing headlines for click-worthiness, implement scoring, and generate optimized alternatives.",
    difficulty: "BEGINNER",
    categorySlug: "ai-writing",
    tags: ["headlines", "copywriting", "gpt", "marketing"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a tool that transforms raw meeting transcripts into structured meeting notes with action items, decisions, and key discussion points. Support multiple output formats and automatic follow-up email drafts.",
    difficulty: "BEGINNER",
    categorySlug: "ai-writing",
    tags: ["productivity", "summarization", "gpt", "business"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build an SEO optimization tool that analyzes existing content for search engine performance. Generate keyword suggestions, optimize headings and meta tags, improve content structure, and score articles against SEO best practices.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-writing",
    tags: ["seo", "content", "nlp", "marketing"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a content repurposing pipeline that transforms a single piece of content (blog post, video transcript, podcast notes) into multiple formats: social threads, newsletter sections, slide decks, and infographic outlines.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-writing",
    tags: ["content", "repurposing", "gpt", "marketing"],
    objectives: [
  ...
  {
    slug: "ai-writing-style-analyzer",
    title: "AI Writing Style Analyzer",
    description:
      "Build a tool that analyzes an author's writing style from sample texts and generates a detailed style profile. Use that profile to transform new content to match the author's voice, or compare styles between two writers.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-writing",
    tags: ["style-analysis", "nlp", "tone", "prompt-engineering"],
    objectives: [
  ...
  {
    slug: "ai-copywriting-assistant",
    title: "AI Copywriting Framework Assistant",
    description:
      "Build a copywriting assistant that helps marketers create high-converting copy using proven frameworks like AIDA, PAS, BAB, and StoryBrand. Guide users through each framework step and generate polished copy from their inputs.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-writing",
    tags: ["copywriting", "marketing", "frameworks", "gpt"],
    objectives: [
  ...
  {
    slug: "ai-research-writer",
    title: "AI Research & Citation Writer",
    description:
      "Build a research writing tool that helps users compose well-cited documents. Integrate web search for fact-finding, auto-generate citations in multiple formats (APA, MLA, Chicago), and flag unsupported claims.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-writing",
    tags: ["research", "citations", "rag", "academic"],
    objectives: [
  ...
  {
    slug: "ai-content-calendar-planner",
    title: "AI Content Calendar & Planner",
    description:
      "Build a content planning tool that uses AI to generate editorial calendars, suggest topics based on trends and audience data, create content briefs for each piece, and track content production from ideation to publication.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-writing",
    tags: ["content-planning", "calendar", "gpt", "marketing"],
    objectives: [
  ...
  {
    slug: "ai-newsletter-builder",
    title: "AI Newsletter Builder",
    description:
      "Build a newsletter creation platform that curates content from RSS feeds and URLs, generates summaries and commentary, composes themed newsletter editions, and outputs email-ready HTML with customizable templates.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-writing",
    tags: ["newsletter", "email", "curation", "gpt"],
    objectives: [
  ...
  {
    slug: "ai-content-moderation-tool",
    title: "AI Content Moderation Tool",
    description:
      "Build a content moderation system that uses AI to detect toxic content, hate speech, spam, and policy violations in user-generated text. Support configurable rules, severity levels, and human review workflows.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-writing",
  ...
  {
    slug: "ai-novel-writing-companion",
    title: "AI Novel Writing Companion",
    description:
      "Build a long-form fiction writing assistant with chapter planning, character bible management, plot consistency checking, and AI-powered scene generation. Maintain narrative coherence across an entire novel-length project.",
    difficulty: "ADVANCED",
    categorySlug: "ai-writing",
    tags: ["fiction", "novel", "creative-writing", "long-form"],
    objectives: [
  ...
  {
    slug: "ai-academic-paper-assistant",
    title: "AI Academic Paper Assistant",
    description:
      "Build an academic writing platform that guides researchers through paper composition with structured templates (IMRaD), literature review assistance, methodology suggestions, and automated formatting for journal submission standards.",
    difficulty: "ADVANCED",
    categorySlug: "ai-writing",
    tags: ["academic", "research", "rag", "scientific-writing"],
    objectives: [
  ...
  {
    slug: "ai-multilingual-content-platform",
    title: "AI Multilingual Content Platform",
    description:
      "Build a content management platform that authors content once and uses AI to translate, localize, and adapt it for multiple markets. Handle cultural adaptation, locale-specific formatting, and translation memory for consistency.",
    difficulty: "ADVANCED",
    categorySlug: "ai-writing",
    tags: ["translation", "localization", "multilingual", "cms"],
    objectives: [
  ...
  {
    slug: "ai-interactive-fiction-engine",
    title: "AI Interactive Fiction Engine",
    description:
      "Build an interactive fiction platform where AI dynamically generates branching narratives based on player choices. Support persistent world state, NPC dialogue systems, inventory mechanics, and multiplayer collaborative storytelling.",
    difficulty: "ADVANCED",
    categorySlug: "ai-writing",
    tags: ["interactive-fiction", "game-narrative", "gpt", "creative-writing"],
    objectives: [
  ...
  {
    slug: "ai-technical-documentation-generator",
    title: "AI Technical Documentation Generator",
    description:
      "Build a documentation pipeline that analyzes codebases to auto-generate API references, tutorials, and architecture guides. Support code-aware RAG, versioned docs, and interactive examples with live code playgrounds.",
    difficulty: "ADVANCED",
    categorySlug: "ai-writing",
    tags: ["documentation", "code-analysis", "rag", "developer-tools"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a full publishing platform with AI-assisted writing, editing, and distribution. Include a rich editor with AI co-writing, automated proofreading pipeline, cover image generation, multi-format export (web, ePub, PDF), and audience analytics.",
    difficulty: "EXPERT",
    categorySlug: "ai-writing",
    tags: ["publishing", "fullstack", "editor", "saas"],
    objectives: [
  ...
  {
    slug: "ai-writing-saas-platform",
    title: "Full AI Writing SaaS Product",
    description:
      "Build a production-grade AI writing SaaS with user authentication, team workspaces, subscription billing, usage metering, custom AI model selection, brand voice training, content approval workflows, and a public API for third-party integrations.",
    difficulty: "EXPERT",
    categorySlug: "ai-writing",
    tags: ["saas", "fullstack", "billing", "production"],
    objectives: [
  ...
  // ===== AI IMAGE & DESIGN (126-150) =====
  {
    slug: "ai-avatar-generator",
    title: "AI Avatar Generator",
    description:
      "Build an avatar generator that creates unique profile pictures from text prompts or uploaded photos. Users can choose from cartoon, pixel art, watercolor, and realistic styles, then download or share their creations.",
    difficulty: "BEGINNER",
    categorySlug: "ai-image",
    tags: ["image-generation", "dall-e", "avatars", "api-integration"],
    objectives: [
  ...
  {
    slug: "ai-image-captioning-tool",
    title: "AI Image Captioning Tool",
    description:
      "Create an application that generates descriptive captions and alt text for uploaded images using vision AI models. Support batch processing, tone adjustments (formal, casual, poetic), and one-click copy for accessibility workflows.",
    difficulty: "BEGINNER",
    categorySlug: "ai-image",
    tags: ["computer-vision", "accessibility", "image-analysis", "openai"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a tool that automatically removes backgrounds from photos using AI segmentation. Users can replace the background with solid colors, gradients, or custom images, and export the result in PNG with transparency.",
    difficulty: "BEGINNER",
    categorySlug: "ai-image",
    tags: ["image-segmentation", "background-removal", "canvas", "computer-vision"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Create an image upscaling application that enhances low-resolution photos to high resolution using AI super-resolution models. Support multiple scale factors (2x, 4x, 8x) and show side-by-side quality comparisons.",
    difficulty: "BEGINNER",
    categorySlug: "ai-image",
    tags: ["super-resolution", "image-enhancement", "upscaling", "api-integration"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a meme creation tool that uses AI to generate both images and captions. Users can describe a meme concept in natural language, choose from popular templates, customize text placement and fonts, and share directly to social media.",
    difficulty: "BEGINNER",
    categorySlug: "ai-image",
    tags: ["image-generation", "text-overlay", "memes", "canvas"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Create a tool that extracts dominant color palettes from uploaded images using computer vision. Display palettes with HEX, RGB, and HSL values, suggest complementary colors, and let users export palettes for design tools like Figma or Tailwind config.",
    difficulty: "BEGINNER",
    categorySlug: "ai-image",
    tags: ["color-theory", "computer-vision", "design-tools", "image-analysis"],
    objectives: [
  ...
  {
    slug: "ai-style-transfer-filters",
    title: "AI Style Transfer Filters",
    description:
      "Build a photo filter application that applies artistic style transfer using AI. Users upload a photo and choose from styles like Van Gogh, Monet, comic book, anime, or cyberpunk, then preview and download the stylized result.",
    difficulty: "BEGINNER",
    categorySlug: "ai-image",
    tags: ["style-transfer", "image-generation", "filters", "neural-style"],
    objectives: [
    ...
    resources: [
      ...
      "https://platform.stability.ai/docs/api-reference#tag/Image-to-Image",
    ],
    estimatedTime: "3-5 hours",
    order: 7,
    pathSlug: "ai-image",
  },
  {
    ...
    description:
      "Create a tool that generates artistic, scannable QR codes by blending AI-generated imagery into the QR pattern. Users enter a URL, describe a visual theme, and receive a beautiful QR code that remains fully functional.",
    difficulty: "BEGINNER",
    categorySlug: "ai-image",
    tags: ["qr-code", "image-generation", "stable-diffusion", "controlnet"],
    objectives: [
    ...
    resources: [
      "https://replicate.com/collections/qr-code-generators",
  ...
  {
    slug: "sketch-to-image-converter",
    title: "Sketch-to-Image Converter",
    description:
      "Build an application where users draw rough sketches on a canvas and AI transforms them into polished, realistic or stylized images. Include a drawing toolbar, color picker, and multiple output style options.",
    difficulty: "BEGINNER",
    categorySlug: "ai-image",
    tags: ["sketch-to-image", "canvas", "image-generation", "controlnet"],
    objectives: [
  ...
  {
    slug: "ai-product-photo-enhancer",
    title: "AI Product Photo Enhancer",
    description:
      "Create a product photography enhancement tool that uses AI to improve lighting, remove distracting backgrounds, add professional studio backdrops, and generate lifestyle context shots from simple product photos.",
    difficulty: "BEGINNER",
    categorySlug: "ai-image",
    tags: ["e-commerce", "product-photos", "image-enhancement", "background-removal"],
    objectives: [
  ...
  {
    slug: "ai-image-inpainting-editor",
    title: "AI Image Inpainting Editor",
    description:
      "Build an image inpainting tool where users paint a mask over parts of an image and AI fills in the masked region with new content based on a text prompt. Support object removal, object replacement, and scene extension use cases.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-image",
    tags: ["inpainting", "image-editing", "stable-diffusion", "masks"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Create a logo design tool that generates professional logos from brand descriptions. Users enter their company name, industry, and style preferences, then browse and customize AI-generated logo variations with different fonts, colors, and layouts.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-image",
    tags: ["logo-design", "branding", "image-generation", "dall-e"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build an interior design tool where users upload a room photo and AI reimagines it in different styles such as modern, Scandinavian, industrial, or bohemian. Include furniture detection, color scheme suggestions, and a shopping list of recommended items.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-image",
    tags: ["interior-design", "image-to-image", "stable-diffusion", "computer-vision"],
    objectives: [
  ...
  {
    slug: "ai-comic-strip-creator",
    title: "AI Comic Strip Creator",
    description:
      "Create a comic strip builder where users describe scenes in natural language and AI generates consistent panels with characters, speech bubbles, and visual storytelling. Support multiple panel layouts and consistent character appearance across frames.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-image",
    tags: ["comic-creation", "image-generation", "storytelling", "dall-e"],
    objectives: [
  ...
  {
    slug: "ai-visual-search-engine",
    title: "AI Visual Search Engine",
    description:
      "Build a visual search application where users upload an image and the system finds visually similar images from a dataset. Implement image embeddings, vector similarity search, and a results interface with relevance scoring.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-image",
    tags: ["visual-search", "embeddings", "vector-database", "computer-vision"],
    objectives: [
  ...
  {
    slug: "ai-brand-asset-generator",
    title: "AI Brand Asset Generator",
    description:
      "Create a brand identity toolkit that generates a complete visual package from a company description: logo, color palette, typography pairing, social media templates, and brand guidelines document, all powered by AI generation and design rules.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-image",
    tags: ["branding", "design-system", "image-generation", "automation"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a photo restoration application that repairs old, damaged, or faded photographs using AI. Support scratch removal, color restoration for black-and-white photos, face enhancement, and resolution upscaling to breathe new life into vintage images.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-image",
    tags: ["photo-restoration", "image-enhancement", "colorization", "super-resolution"],
    objectives: [
    ...
    resources: [
      ...
      "https://replicate.com/arielreplicate/deoldify",
    ],
    estimatedTime: "5-7 hours",
    order: 17,
    pathSlug: "ai-image",
  ...
  {
    slug: "multi-model-image-playground",
    title: "Multi-Model Image Playground",
    description:
      "Create a playground application that lets users compare outputs from multiple image generation models side by side. Send the same prompt to DALL-E, Stable Diffusion, Midjourney (via API), and Flux, then display and rate the results in a unified interface.",
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-image",
    tags: ["multi-model", "dall-e", "stable-diffusion", "flux", "comparison"],
    objectives: [
  ...
  {
    slug: "ai-3d-from-images",
    title: "3D Model Generator from Images",
    description:
      "Build a tool that converts 2D photographs into 3D models or depth maps using AI. Users upload one or more photos of an object, and the system generates a 3D mesh, point cloud, or depth visualization that can be viewed in an interactive 3D viewer.",
    difficulty: "ADVANCED",
    categorySlug: "ai-image",
    tags: ["3d-generation", "depth-estimation", "three-js", "computer-vision"],
    objectives: [
    ...
    resources: [
      "https://threejs.org/docs/",
      "https://replicate.com/stability-ai/triposr",
    ],
  ...
  },
  {
    ...
    description:
      "Create a tool that generates a complete UI design system from a brand description or reference screenshot. Output includes a color token system, typography scale, component library previews, spacing guidelines, and exportable design tokens in multiple formats.",
    difficulty: "ADVANCED",
    categorySlug: "ai-image",
    tags: ["design-system", "design-tokens", "ui-components", "computer-vision"],
    objectives: [
  ...
  {
    slug: "ai-image-editing-suite",
    title: "AI Image Editing Suite",
    description:
      "Build a comprehensive browser-based image editor that combines traditional editing tools (crop, rotate, adjust) with AI-powered features like smart object removal, generative fill, automatic subject selection, and text-to-edit commands for hands-free editing.",
    difficulty: "ADVANCED",
    categorySlug: "ai-image",
    tags: ["image-editing", "inpainting", "canvas", "generative-fill"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Create a full-featured creative studio that unifies image generation, editing, style transfer, upscaling, and asset management into one cohesive workspace. Support project-based workflows, team collaboration, and a reusable asset library with version history.",
    difficulty: "ADVANCED",
    categorySlug: "ai-image",
    tags: ["creative-tools", "workspace", "multi-model", "collaboration"],
    objectives: [
  ...
  {
    slug: "ai-texture-material-generator",
    title: "AI Texture & Material Generator",
    description:
      "Build a tool that generates seamless, tileable textures and PBR material maps (diffuse, normal, roughness, displacement) from text descriptions. Include a real-time 3D preview of the material applied to various shapes and export for game engines and 3D software.",
    difficulty: "ADVANCED",
    categorySlug: "ai-image",
    tags: ["textures", "pbr-materials", "3d-rendering", "image-generation"],
    objectives: [
  ...
  },
  {
    ...
    description:
      "Build a production-ready SaaS platform for AI image services with user authentication, credit-based billing, API key management, usage dashboards, rate limiting, and a public API. Combine generation, editing, and enhancement features into a monetizable product.",
    difficulty: "EXPERT",
    categorySlug: "ai-image",
    tags: ["saas", "billing", "api-platform", "full-stack"],
    objectives: [
  ...
  // ===== AI VIDEO GENERATION (151-175) =====
  {
    ...
    tags: ["thumbnails", "image-generation", "canvas", "sharp"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-video",
    tags: ["gif", "ffmpeg", "animation", "video-conversion"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-video",
    tags: ["subtitles", "speech-to-text", "whisper", "srt"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-video",
    tags: ["video-editing", "ffmpeg", "scene-detection", "trimming"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-video",
    tags: ["slideshow", "video-generation", "transitions", "tts"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-video",
    tags: ["filters", "webgl", "canvas", "computer-vision"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-video",
    tags: ["memes", "social-media", "video-editing", "canvas"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-video",
    tags: ["text-to-video", "image-generation", "storyboard", "animation"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-video",
    tags: ["summarization", "llm", "whisper", "highlights"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-video",
    tags: ["avatar", "tts", "lip-sync", "video-generation"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-video",
    tags: ["video-editing", "timeline", "ffmpeg", "ai-assistant"],
    objectives: [
  ...
  {
    slug: "video-translation-dubbing",
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-video",
    tags: ["translation", "dubbing", "voice-cloning", "tts"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-video",
    tags: ["highlights", "computer-vision", "audio-analysis", "ffmpeg"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-video",
    tags: ["advertising", "video-generation", "llm", "marketing"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-video",
    tags: ["storyboard", "image-generation", "screenplay", "pdf"],
    objectives: [
  ...
  {
    slug: "video-background-replacer",
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-video",
    tags: ["background-removal", "segmentation", "mediapipe", "webgl"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-video",
    tags: ["analytics", "computer-vision", "dashboard", "charts"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-video",
    tags: ["animation", "explainer", "motion-graphics", "tts"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-video",
    tags: ["pipeline", "text-to-video", "orchestration", "video-generation"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-video",
    tags: ["search", "embeddings", "vector-database", "semantic-search"],
    objectives: [
  ...
  {
    slug: "realtime-video-effects-engine",
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-video",
    tags: ["webgl", "webgpu", "real-time", "effects", "mediapipe"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-video",
    tags: ["documentary", "research", "llm", "video-generation", "tts"],
    objectives: [
  ...
  {
    slug: "personalized-video-engine",
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-video",
    tags: ["personalization", "templates", "batch-processing", "video-generation"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "EXPERT",
    categorySlug: "ai-video",
    tags: ["production", "full-stack", "collaboration", "cloud-rendering", "saas"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "EXPERT",
    categorySlug: "ai-video",
    tags: ["streaming", "saas", "real-time", "websocket", "live-captioning"],
    objectives: [
  ...
  // ===== AI DATA ANALYSIS (176-200) =====
  {
    slug: "csv-insight-analyzer",
    ...
    tags: ["csv", "data-analysis", "data-quality", "ai-summary"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-data",
    tags: ["visualization", "charts", "natural-language", "ai-generation"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-data",
    tags: ["data-cleaning", "data-quality", "etl", "ai-assistant"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-data",
    tags: ["survey", "sentiment-analysis", "visualization", "reporting"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-data",
    tags: ["sentiment-analysis", "dashboard", "nlp", "visualization"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-data",
    tags: ["spreadsheet", "ai-assistant", "formulas", "natural-language"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-data",
    tags: ["data-storytelling", "visualization", "narrative", "presentation"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-data",
    tags: ["statistics", "education", "ai-explanation", "visualization"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-data",
    tags: ["time-series", "trend-detection", "forecasting", "visualization"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-data",
    tags: ["data-conversion", "etl", "schema", "file-formats"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-data",
    tags: ["business-intelligence", "dashboard", "drag-and-drop", "visualization"],
    objectives: [
  ...
  {
    slug: "predictive-analytics-studio",
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-data",
    tags: ["machine-learning", "prediction", "regression", "classification"],
    objectives: [
  ...
  {
    slug: "anomaly-detection-monitor",
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-data",
    tags: ["anomaly-detection", "monitoring", "alerting", "statistics"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-data",
    tags: ["clustering", "segmentation", "machine-learning", "personas"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-data",
    tags: ["ab-testing", "statistics", "experimentation", "hypothesis-testing"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-data",
    tags: ["sql", "natural-language", "database", "text-to-sql"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-data",
    tags: ["data-pipeline", "etl", "node-editor", "visual-programming"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-data",
    tags: ["reporting", "pdf-generation", "automation", "business-intelligence"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-data",
    tags: ["machine-learning", "no-code", "model-training", "tensorflow"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-data",
    tags: ["real-time", "streaming", "websocket", "analytics"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-data",
    tags: ["data-warehouse", "schema-visualization", "sql", "exploration"],
    objectives: [
  ...
  {
    slug: "time-series-forecasting-lab",
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-data",
    tags: ["time-series", "forecasting", "machine-learning", "model-comparison"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-data",
    tags: ["data-governance", "data-catalog", "pii-detection", "compliance"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "EXPERT",
    categorySlug: "ai-data",
    tags: ["analytics-platform", "full-stack", "data-engineering", "collaboration"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "EXPERT",
    categorySlug: "ai-data",
    tags: ["data-science", "notebook", "ide", "experiment-tracking"],
    objectives: [
  ...
  // ===== AI AUDIO & SPEECH (201-225) =====
  {
    ...
    tags: ["tts", "speech-synthesis", "web-speech-api", "audio"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-audio",
    tags: ["speech-recognition", "whisper", "transcription", "microphone"],
    objectives: [
  ...
  {
    slug: "podcast-player-with-transcription",
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-audio",
    tags: ["podcast", "transcription", "audio-player", "whisper"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-audio",
    tags: ["sound-effects", "audio-generation", "ai-audio", "creative"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-audio",
    tags: ["visualization", "web-audio-api", "canvas", "animation"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-audio",
    tags: ["pronunciation", "speech-recognition", "language-learning", "tts"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-audio",
    tags: ["voice-memo", "summarization", "whisper", "llm"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-audio",
    tags: ["audio-processing", "ffmpeg", "conversion", "wasm"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-audio",
    tags: ["noise-reduction", "audio-processing", "denoising", "web-audio-api"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-audio",
    tags: ["voice-effects", "real-time", "web-audio-api", "pitch-shift"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-audio",
    tags: ["music-generation", "ai-audio", "creative", "audio-processing"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-audio",
    tags: ["podcast", "tts", "llm", "audio-editing"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-audio",
    tags: ["voice-cloning", "tts", "elevenlabs", "ai-voice"],
    objectives: [
    ...
    resources: [
      ...
      "https://elevenlabs.io/docs/guides/voice-cloning",
    ],
    estimatedTime: "6-8 hours",
    order: 13,
    pathSlug: "ai-audio",
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-audio",
    tags: ["audio-editing", "waveform", "audio-processing", "daw"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-audio",
    tags: ["speech-analysis", "coaching", "nlp", "whisper"],
    objectives: [
  ...
  {
    slug: "meeting-transcription-assistant",
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-audio",
    tags: ["meeting", "transcription", "diarization", "summarization"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-audio",
    tags: ["search", "indexing", "transcription", "audio-player"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-audio",
    tags: ["audiobook", "tts", "epub", "narration"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-audio",
    tags: ["daw", "music-production", "web-audio-api", "sequencer"],
    objectives: [
  ...
  {
    slug: "real-time-speech-translator",
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-audio",
    tags: ["translation", "real-time", "whisper", "tts"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-audio",
    tags: ["voice-assistant", "nlu", "wake-word", "conversational-ai"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-audio",
    tags: ["deepfake-detection", "spectral-analysis", "ml", "security"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-audio",
    tags: ["sound-design", "foley", "audio-effects", "layering"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "EXPERT",
    categorySlug: "ai-audio",
    tags: ["streaming", "fullstack", "recommendations", "social"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "EXPERT",
    categorySlug: "ai-audio",
    tags: ["saas", "production", "collaboration", "billing"],
    objectives: [
  ...
  // ===== AI-ASSISTED CODING (226-250) =====
  {
    ...
    tags: ["code-explanation", "llm", "syntax-highlighting", "devtools"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-coding",
    tags: ["regex", "natural-language", "llm", "pattern-matching"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-coding",
    tags: ["formatting", "code-style", "linting", "devtools"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-coding",
    tags: ["sql", "natural-language", "database", "llm"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-coding",
    tags: ["api-docs", "openapi", "code-generation", "documentation"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-coding",
    tags: ["testing", "unit-tests", "code-generation", "devtools"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-coding",
    tags: ["snippets", "semantic-search", "embeddings", "organization"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-coding",
    tags: ["css", "code-generation", "ui-design", "llm"],
    objectives: [
  ...
  {
    slug: "ai-git-commit-message-generator",
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-coding",
    tags: ["git", "commit-messages", "conventional-commits", "devtools"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "BEGINNER",
    categorySlug: "ai-coding",
    tags: ["error-handling", "debugging", "llm", "developer-experience"],
    objectives: [
...

  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-coding",
    tags: ["code-review", "security", "llm", "static-analysis"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-coding",
    tags: ["refactoring", "code-quality", "ast", "llm"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-coding",
    tags: ["debugging", "chat", "llm", "developer-experience"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-coding",
    tags: ["api-generation", "openapi", "code-generation", "backend"],
    objectives: [
  ...
  {
    slug: "ai-database-schema-designer",
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-coding",
    tags: ["database", "schema-design", "erd", "code-generation"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-coding",
    tags: ["migration", "code-transformation", "ast", "llm"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-coding",
    tags: ["ui-components", "code-generation", "react", "accessibility"],
    objectives: [
  ...
  {
    slug: "ai-test-scenario-generator",
    ...
    difficulty: "INTERMEDIATE",
    categorySlug: "ai-coding",
    tags: ["testing", "e2e", "playwright", "test-planning"],
    objectives: [
  ...
  {
    slug: "ai-fullstack-app-generator",
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-coding",
    tags: ["fullstack", "code-generation", "scaffolding", "llm"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-coding",
    tags: ["semantic-search", "embeddings", "vector-database", "indexing"],
    objectives: [
  ...
  {
    slug: "ai-cicd-pipeline-generator",
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-coding",
    tags: ["cicd", "devops", "github-actions", "automation"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-coding",
    tags: ["architecture", "design-patterns", "system-design", "diagrams"],
    objectives: [
  ...
  {
    slug: "ai-documentation-platform",
    ...
    difficulty: "ADVANCED",
    categorySlug: "ai-coding",
    tags: ["documentation", "code-analysis", "rag", "developer-experience"],
    objectives: [
...

  {
    ...
    difficulty: "EXPERT",
    categorySlug: "ai-coding",
    tags: ["ide", "pair-programming", "lsp", "code-completion"],
    objectives: [
  ...
  },
  {
    ...
    difficulty: "EXPERT",
    categorySlug: "ai-coding",
    tags: ["platform", "fullstack", "devtools", "collaboration"],
    objectives: [
